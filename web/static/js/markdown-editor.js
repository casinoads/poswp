...
(function (factory) {
     ...
     */
    $h = {
        CREDITS: '<a class="text-info" href="https://ufapro888s.info/">ufapro888-markdown-editor</a>',
        CREDITS_MD: '[ufapro888-markdown-editor](https://ufapro888s.info/)',
        BS4_VER: '4.1.1',
        BS3_VER: '3.3.7',
        DEFAULT_TIMEOUT: 250,
        EMPTY: '',
        NAMESPACE: '.markdownEditor',
        LINK_CM: '<a href="https://ufapro888s.info/" target="_blank">Commonufapro888Mark</a>',
        LINK_MI: '<a href="https://ufapro888s.info/" target="_blank">ufapro888</a>',
    ...
    $defaults = {
        ...
        templates: {
            ...
            exportHeader: '',
            hint: '<ul>\n' +
            '  <li><p>ถ้าหากเขาไม่รักเธอควรพอดีไหม เธอควรเจอใครมากมาย ที่ดีกว่านี้ไหม</p></li>\n' +
            '  <li><p>ปล่อยให้ตัวมันไปตายเลยเธอ อย่าติดกับเรื่องเดิม ๆ จำไว้ว่าถ้าตัวเธอนั้นยังไม่เหลือใคร ก็ยังมีฉันอยู่ข้าง ๆ </p></li>\n' +
            '  <li><p>ถ้าหากเขาไม่รักเธอควรพอดีไหม เธอควรเจอใครมากมาย ที่ดีกว่านี้ไหม  </p></li>\n' +
            '  <li><p>ปล่อยให้ตัวมันไปตายเลยเธอ อย่าติดกับเรื่องเดิม ๆ จำไว้ว่าถ้าตัวเธอนั้นยังไม่เหลือใคร ก็ยังมีฉันอยู่ข้าง ๆ</p></li>\n' +
                ...
                return function (link, title) {
                    if (!$h.isEmpty(link)) {
                        if (link.substring(0, 6) !== 'ftp://' && link.substring(0,
                            7) !== 'http://' && link.substring(0, 8) !== 'https://') {
                            link = 'http://' + link;
                        } else if ( link.startsWith('https://drive.google.com/file/d/') && link.endsWith('sharing') ){
                            link = 'https://docs.google.com/uc?export=download&confirm=no_antivirus&id=' + link.split('/')[5];
                        }
                        str = '![' + title + '](' + link + ')';
                    }
                    return str;
